...
import psl.conversation.training.VectorMath;
import psl.conversation.training.Centroid;

public class implKeywordFinder implements KeywordFinder {
	private final double DECAY_FACTOR = 1; // change decay to no decay
	
	private String configfileName = "psl/conversation/keywords2/KeywordFinderConfig.xml";
